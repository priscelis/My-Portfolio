...
function Navbar() {
  return (
    <>
    <nav className='navbarbg bg-fondo p-3 h-20 p-8 flex justify-between border-borde border-b-[2.5px] items-center'>
    <ul>
     <li>
      ...
      <ul className='flex flex-row justify-end h-13.75 gap-7 items-center'>
       ...
       <li> 
        <a href="#" className=" font-fraunces text-[18px] relative inline-block text-text after:content-[''] after:rounded-[40px] after:absolute after:left-0 after:bottom-0 after:w-full after:h-0.5 after:bg-borde after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100 ">Sobre mi
        </a>
        </li>
        <li>
